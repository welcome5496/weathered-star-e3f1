...
```
npm create cloudflare@latest -- --template=cloudflare/templates/weathered-star-e3f1
```

A live public deployment of this template is available at [https://weathered-star-e3f1.templates.workers.dev](https://weathered-star-e3f1.templates.workers.dev)
